<?php
/**
 * Title: Front Page Section: Contact
 * Slug: wi-sonx-fse/section-front-page-contact
 * Categories: contact
 * Keywords: front page, section, contact
 * Post Types: page
...
<!-- wp:wi-sonx-fse/front-page-section {"anchor":"contact","lock":{"move":true,"remove":true}} -->
<section
	...
	id="contact" data-wp-interactive="wi-sonx-fse/front-page-section"
	data-wp-init="wi-sonx-fse/front-page-toc::callbacks.register">
	<div class="wp-block-wi-sonx-fse-front-page-section-content">
		...
		<div class="wp-block-group"
			...
			<h2 class="wp-block-heading has-xx-large-font-size"><?php esc_html_e( 'Contact', 'wi-sonx-fse' ); ?></h2>
			<!-- /wp:heading -->
		</div>
		<!-- /wp:group -->
	</div>
