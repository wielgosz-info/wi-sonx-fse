...
<!-- wp:query {<?php null !== $wi_sonx_fse_query_id ? printf( '"queryId": %d,', intval( $wi_sonx_fse_query_id ) ) : ''; ?>"query":{"perPage":"8","pages":0,"offset":0,"postType":"wi-project","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false,"parents":[]},"enhancedPagination":true,"className":"wi-loop-portfolio-grid"} -->
