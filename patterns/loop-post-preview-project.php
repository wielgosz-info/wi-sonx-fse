...
<article class="wp-block-group wi-loop-post-preview-project" style="min-height:100%">
	<!-- wp:group {"backgroundColor":"off-base","className":"wi-loop-post-preview-project-image"} -->
	<div class="wp-block-group wi-loop-post-preview-project-image has-off-base-background-color has-background">
