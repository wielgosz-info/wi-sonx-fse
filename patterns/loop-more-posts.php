...
<!-- wp:query {<?php null !== $wi_sonx_fse_query_id ? printf( '"queryId": %d,', intval( $wi_sonx_fse_query_id ) ) : ''; ?>"query":{"perPage":"3","pages":"4","offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"exclude","inherit":false},"enhancedPagination":true,"className":"wi-loop-more-posts","layout":{"type":"default"}} -->
