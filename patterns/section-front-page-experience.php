<?php
/**
 * Title: Front Page Section: Experience
 * Slug: wi-sonx-fse/section-front-page-experience
 * Categories: about, portfolio
 * Keywords: front page, section, experience
 * Post Types: page
...
<section
	...
	id="experience" data-wi-toc="true">
	<div class="wp-block-wi-sonx-fse-front-page-section-content">
		...
		<div class="wp-block-group"
			...
			<h2 class="wp-block-heading has-xx-large-font-size"><?php esc_html_e( "Experience", 'wi-sonx-fse' ); ?></h2>
			<!-- /wp:heading -->
		</div>
		<!-- /wp:group -->
	</div>
