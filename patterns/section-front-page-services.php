<?php
/**
 * Title: Front Page Section: Services
 * Slug: wi-sonx-fse/section-front-page-services
 * Categories: services
 * Keywords: front page, section, services
 * Post Types: page
...
<!-- wp:wi-sonx-fse/front-page-section {"anchor":"services","lock":{"move":true,"remove":true}} -->
<section
	...
	id="services" data-wp-interactive="wi-sonx-fse/front-page-section" data-wp-init="wi-sonx-fse/front-page-toc::callbacks.register">
	<div class="wp-block-wi-sonx-fse-front-page-section-content">
		...
		<div class="wp-block-group"
			...
			<h2 class="wp-block-heading has-xx-large-font-size"><?php esc_html_e( 'Services', 'wi-sonx-fse' ); ?></h2>
			<!-- /wp:heading -->

			<!-- wp:pattern {"slug":"wi-sonx-fse/loop-services-slider"} /-->
		</div>
		<!-- /wp:group -->
	</div>
</section>
