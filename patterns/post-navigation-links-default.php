...
<div class="wp-block-group alignwide has-border-color has-contrast-border-color has-large-font-size"
	...
	<?php if( is_rtl() ): ?>
		<!-- wp:post-navigation-link {"type":"next","showTitle":true,"linkLabel":true,"label":"<?php esc_html_e( 'Next project', 'wi-sonx-fse' ); ?>","arrow":"chevron","style":{"layout":{"columnSpan":"5"}}} /-->
	<?php else : ?>
		<!-- wp:post-navigation-link {"type":"previous","showTitle":true,"linkLabel":true,"label":"<?php esc_html_e( 'Previous project', 'wi-sonx-fse' ); ?>","arrow":"chevron","style":{"layout":{"columnSpan":"5"}}} /-->
	<?php endif; ?>
	...
	<?php if( is_rtl() ): ?>
		<!-- wp:post-navigation-link {"type":"previous","textAlign":"right","showTitle":true,"linkLabel":true,"label":"<?php esc_html_e( 'Previous project', 'wi-sonx-fse' ); ?>","arrow":"chevron","style":{"layout":{"columnSpan":"5"}}} /-->
	<?php else : ?>
		<!-- wp:post-navigation-link {"type":"next","textAlign":"right","showTitle":true,"linkLabel":true,"label":"<?php esc_html_e( 'Next project', 'wi-sonx-fse' ); ?>","arrow":"chevron","style":{"layout":{"columnSpan":"5"}}} /-->
	<?php endif; ?>
</div>
<!-- /wp:group -->
